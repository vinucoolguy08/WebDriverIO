...
export const config: Options.Testrunner = {
    ...
    // services: [['selenium-standalone', { drivers: { chrome: '84.0.4147.30', chromiumedge: 'latest' } }]],
    // capabilities: [{   
    //     maxInstances: 5,
    //     //
    //     browserName: 'chrome',
     ...
     * afterEach in Mocha)
     */
    //Take Screenshot for the error pages
